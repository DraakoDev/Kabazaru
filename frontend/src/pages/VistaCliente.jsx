...
export const VistaCliente = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <button
        onClick={logout}
        className="bg-amber-500 hover:bg-amber-700 hover:cursor-pointer p-3.5 rounded-2xl"
      >
        Cerrar Sesion
      </button>
      {/* STATS */}
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        <StatCard title="Compras" value="12" icon={<ShoppingCart />} />

        <StatCard title="Favoritos" value="28" icon={<Heart />} />

        <StatCard title="Vehículos vistos" value="134" icon={<Car />} />

        <StatCard title="Presupuesto" value="$80M" icon={<DollarSign />} />
      </section>
      ...
      <section className="glass rounded-3xl p-6 overflow-hidden">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold">Vehículos favoritos</h2>
